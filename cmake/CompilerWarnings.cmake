...
function(e2d_set_target_warnings target)
    e2d_set_option(WARNINGS_AS_ERRORS TRUE BOOL "True to treat compiler warnings as errors, FALSE otherwise (default TRUE).")
    ...
    if(E2D_COMPILER_GCC OR E2D_COMPILER_CLANG)
        target_compile_options(${target} PRIVATE
            ...
            -Wno-main # allow main() to be called
        )
    endif()
